        ...
        {selectedTab === 0 && (
          <div>
            ...
            >
              ...
              >
                <img
                  src={profile?.user_avatar || "../../../../public/profile.png"}
                  alt="Profile"
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                <div style={{ flex: 1 }}>
                  <TextField
                    label={
                      originalProfile?.user_phone_number ? "" : "Số điện thoại"
                    }
                    variant="outlined"
                    fullWidth
                    ...
                    onChange={(e) =>
                      setProfile(
                        profile
                          ? { ...profile, user_phone_number: e.target.value }
                          : undefined,
                      )
                    }
                    style={{ marginBottom: "16px" }}
                ...
                <div style={{ flex: 1 }}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setProfile(
                        profile
                          ? { ...profile, user_email: e.target.value }
                          : undefined,
                      )
                    }
                    style={{ marginBottom: "16px" }}
